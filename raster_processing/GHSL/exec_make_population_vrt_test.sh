...
SERVICEDIR="/data/datasets/scripts/servicefiles"
...
WORKINGDIR="/data/datasets/scripts/misc"
INRASTER_PATH="/data/datasets/population/tif/"
VRT_PATH="/data/datasets/population/"
LIST="filelist.txt"
POP_MAPSET=${LOCATION_LL_PATH}"/POP"
NCORES=48
