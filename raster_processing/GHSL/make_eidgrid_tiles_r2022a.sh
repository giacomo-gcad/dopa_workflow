...
INDIR="/spatial_data/Original_Datasets/GHSL/uncompressed/builtup/R2022A"
OUTDIR_ROOT="/spatial_data/Derived_Datasets/RASTER/GHSL/R2022A/builtup/tiles_"
...
for year in 1975 1980 1990 2000 2010 2020
	do
	INFILE="GHS_BUILT_S_E"${year}"_GLOBE_R2022A_54009_100_V1_0.tif"
...
-ot UInt16 -te ${minx} ${miny} ${maxx} ${maxy} -tr 0.0008888888888 0.0008888888888 -t_srs EPSG:4326 \
