...
# ls -1 ${DATABASE}/${LOCATION_LL}/${PABU_MAPSET}"/cell/ceptile*"| sed 's/ceptile_//' >pabu_tiles.txt
ls -1 ${DATABASE}/${LOCATION_LL}/${PABU_MAPSET}"/cell" | sed 's/ceptile_//' >pabu_tiles.txt
...
rm -f ${RESULTSPATH}/cid_area_built_*.csv
