...
for IN_RASTER in mspa_lc_1995 mspa_lc_2000 mspa_lc_2005 mspa_lc_2010 mspa_lc_2015
do
...
echo "---------------------------------------------------------------------------------------"
echo "Stats on CEP and 5 Land Fragmentation datasets computed in "${runtime}" minutes using "${NCORES}" cores "
echo "---------------------------------------------------------------------------------------"
exit
