...
-- SELECT THE THEME;
DROP TABLE IF EXISTS theme; CREATE TEMPORARY TABLE theme AS SELECT * FROM results_202601_cep_in.r_univar_cep_gsoc_16_100m_202601;
-- SELECT THE GRID;
...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS results_202601_cep_out.country_carbon_soil_organic;
CREATE TABLE results_202601_cep_out.country_carbon_soil_organic AS
SELECT
a.country_id,a.min gsoc_min_c_mg_total,a.max gsoc_max_c_mg_total,a.mean gsoc_mean_c_mg_total,a.sum/1000000000 gsoc_tot_c_pg_total,
...
/* -- ecoregion
DROP TABLE IF EXISTS results_202601_cep_out.ecoregion_carbon_soil_organic;
CREATE TABLE results_202601_cep_out.ecoregion_carbon_soil_organic AS
SELECT
...
-- pa
DROP TABLE IF EXISTS results_202601_cep_out.wdpa_carbon_soil_organic;
CREATE TABLE results_202601_cep_out.wdpa_carbon_soil_organic AS
