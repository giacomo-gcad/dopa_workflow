...
--------------------------------------------
-- country
DROP TABLE IF EXISTS :v_rcep_out.country_global_forest_cover_loss; CREATE TABLE :v_rcep_out.country_global_forest_cover_loss AS
SELECT * FROM country_change_in_forest_cover_loss;
-- ecoregion
DROP TABLE IF EXISTS :v_rcep_out.ecoregion_global_forest_cover_loss; CREATE TABLE :v_rcep_out.ecoregion_global_forest_cover_loss AS
SELECT * FROM ecoregion_change_in_forest_cover_loss;
-- protection
DROP TABLE IF EXISTS :v_rcep_out.wdpa_global_forest_cover_loss; CREATE TABLE :v_rcep_out.wdpa_global_forest_cover_loss AS
