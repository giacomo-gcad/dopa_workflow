DROP TABLE IF EXISTS :v_rcep_out.wdpa_pressure_roads_bu;CREATE TABLE :v_rcep_out.wdpa_pressure_roads_bu AS
WITH
...
FROM :v_rcep_out.pabu_intermediate_p_roads_bu
...
SELECT wdpaid,
--land_sqkm,
--theme_sqkm AS p_roads_pa_sqkm,
ROUND((theme_sqkm/land_sqkm*100)::numeric,2) p_road_bu_perc_tot
