DROP TABLE IF EXISTS :v_rcep_out.wdpa_pressure_builtup_pa;CREATE TABLE :v_rcep_out.wdpa_pressure_builtup_pa AS
WITH
...
FROM :v_rcep_out.wdpa_intermediate_p_builtup
...
SELECT wdpaid,
--land_sqkm,
theme_sqkm AS p_builtup_pa_sqkm,
ROUND((theme_sqkm/land_sqkm*100)::numeric,2) p_builtup_pa_perc_land
