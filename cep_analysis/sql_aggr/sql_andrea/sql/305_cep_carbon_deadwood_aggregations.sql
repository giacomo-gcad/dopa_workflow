...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS :v_rcep_out.country_carbon_dead_wood;
CREATE TABLE :v_rcep_out.country_carbon_dead_wood AS
SELECT
...
-- ecoregion
DROP TABLE IF EXISTS :v_rcep_out.ecoregion_carbon_dead_wood;
CREATE TABLE :v_rcep_out.ecoregion_carbon_dead_wood AS
SELECT
...
-- pa
DROP TABLE IF EXISTS :v_rcep_out.wdpa_carbon_dead_wood;
CREATE TABLE :v_rcep_out.wdpa_carbon_dead_wood AS
