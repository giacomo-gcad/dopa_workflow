...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS :v_rcep_out.country_carbon_litter;
CREATE TABLE :v_rcep_out.country_carbon_litter AS
SELECT
a.country country_id,a.min ltc_min_c_mg_total,a.max ltc_max_c_mg_total,a.mean ltc_mean_c_mg_total,a.sum/1000000000 ltc_tot_c_pg_total,
...
-- ecoregion
DROP TABLE IF EXISTS :v_rcep_out.ecoregion_carbon_litter;
CREATE TABLE :v_rcep_out.ecoregion_carbon_litter AS
SELECT
...
-- pa
DROP TABLE IF EXISTS :v_rcep_out.wdpa_carbon_litter;
CREATE TABLE :v_rcep_out.wdpa_carbon_litter AS
