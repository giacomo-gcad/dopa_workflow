...
-- SELECT THE THEME;
DROP TABLE IF EXISTS theme; CREATE TEMPORARY TABLE theme AS SELECT * FROM results_202601_cep_in.r_univar_cep_ltc2022_100m_202601;
-- SELECT THE GRID;
...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS results_202601_cep_out.country_carbon_litter;
CREATE TABLE results_202601_cep_out.country_carbon_litter AS
SELECT
a.country_id,a.min ltc_min_c_mg_total,a.max ltc_max_c_mg_total,a.mean ltc_mean_c_mg_total,a.sum/1000000000 ltc_tot_c_pg_total,
b.min ltc_min_c_mg_prot,b.max ltc_max_c_mg_prot,b.mean ltc_mean_c_mg_prot,b.sum/1000000000 ltc_tot_c_pg_prot,
c.min ltc_min_c_mg_unprot,c.max ltc_max_c_mg_unprot,c.mean ltc_mean_c_mg_unprot,c.sum/1000000000 ltc_tot_c_pg_unprot
FROM country_land a 
LEFT JOIN country_land_prot b USING(country_id)
LEFT JOIN country_land_unprot c USING(country_id);
/* -- ecoregion
DROP TABLE IF EXISTS results_202601_cep_out.ecoregion_carbon_litter;
CREATE TABLE results_202601_cep_out.ecoregion_carbon_litter AS
SELECT
a.ecoregion eco_id,a.min ltc_min_c_mg_total,a.max ltc_max_c_mg_total,a.mean ltc_mean_c_mg_total,a.sum/1000000000 ltc_tot_c_pg_total,
b.min ltc_min_c_mg_prot,b.max ltc_max_c_mg_prot,b.mean ltc_mean_c_mg_prot,b.sum/1000000000 ltc_tot_c_pg_prot,
c.min ltc_min_c_mg_unprot,c.max ltc_max_c_mg_unprot,c.mean ltc_mean_c_mg_unprot,c.sum/1000000000 ltc_tot_c_pg_unprot
FROM eco_land a 
...
-- pa
DROP TABLE IF EXISTS results_202601_cep_out.wdpa_carbon_litter;
CREATE TABLE results_202601_cep_out.wdpa_carbon_litter AS
SELECT pa wdpaid,min ltc_min_c_mg,max ltc_max_c_mg,mean ltc_mean_c_mg,sum ltc_tot_c_mg FROM pa_land;
