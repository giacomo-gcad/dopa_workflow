...
DROP MATERIALIZED VIEW IF EXISTS dopa_50.dopa_country_all_inds_template;CREATE MATERIALIZED VIEW dopa_50.dopa_country_all_inds_template AS
SELECT 
	country_id,
	country_name,
	iso3,
...
FROM dopa_50.dopa_country_all_inds LIMIT 0;
GRANT SELECT ON dopa_50.dopa_country_all_inds_template TO h05ibexro;

SELECT * FROM dopa_50.dopa_country_all_inds_template;
...
COMMENT ON FUNCTION dopa_50.get_dopa_country_all_inds(text, text) IS
