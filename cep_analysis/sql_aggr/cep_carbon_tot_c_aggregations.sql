...
-- SELECT THE THEME;
DROP TABLE IF EXISTS theme; CREATE TEMPORARY TABLE theme AS SELECT * FROM results_202601_cep_in.r_univar_cep_total_carbon_2022_202601;
-- SELECT THE GRID;
...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS results_202601_cep_out.country_carbon_total;
CREATE TABLE results_202601_cep_out.country_carbon_total AS
SELECT
a.country_id,a.min carbon_min_c_mg_total,a.max carbon_max_c_mg_total,a.mean carbon_mean_c_mg_total,a.sum/1000000000 carbon_tot_c_pg_total,
...
/* -- ecoregion
DROP TABLE IF EXISTS results_202601_cep_out.ecoregion_carbon_total;
CREATE TABLE results_202601_cep_out.ecoregion_carbon_total AS
SELECT
...
-- pa
DROP TABLE IF EXISTS results_202601_cep_out.wdpa_carbon_total;
CREATE TABLE results_202601_cep_out.wdpa_carbon_total AS
