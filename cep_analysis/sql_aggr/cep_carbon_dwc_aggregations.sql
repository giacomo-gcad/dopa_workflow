...
-- SELECT THE THEME;
DROP TABLE IF EXISTS theme; CREATE TEMPORARY TABLE theme AS SELECT * FROM results_202601_cep_in.r_univar_cep_dwc2022_100m_202601;
-- SELECT THE GRID;
...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS results_202601_cep_out.country_carbon_dead_wood;
CREATE TABLE results_202601_cep_out.country_carbon_dead_wood AS
SELECT
a.country_id,a.min dwc_min_c_mg_total,a.max dwc_max_c_mg_total,a.mean dwc_mean_c_mg_total,a.sum/1000000000 dwc_tot_c_pg_total,
...
/* -- ecoregion
DROP TABLE IF EXISTS results_202601_cep_out.ecoregion_carbon_dead_wood;
CREATE TABLE results_202601_cep_out.ecoregion_carbon_dead_wood AS
SELECT
...
-- pa
DROP TABLE IF EXISTS results_202601_cep_out.wdpa_carbon_dead_wood;
CREATE TABLE results_202601_cep_out.wdpa_carbon_dead_wood AS
