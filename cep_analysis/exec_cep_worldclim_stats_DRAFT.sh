...
IN_RASTER_ROOT="worldclim_prec_"
...
do
	...
	do	
		...
		wait
		echo "./slave_cep_conraster_stats.sh ${eid} ${TMP_MAPSET_PATH} ${RESULTSPATH} ${IN_RASTER_ROOT}${MONTH}@${IN_RASTER_MAPSET} ${OUTCSV} ${CEP_MAPSET}"
...
echo "---------------------------------------------------"
echo "precipitations in ${runtime} minutes"
echo "---------------------------------------------------"
