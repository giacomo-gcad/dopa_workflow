...
DROP TABLE IF EXISTS :vSCHEMA.wdoecm_geom_:vDATE;
CREATE TABLE :vSCHEMA.wdoecm_geom_:vDATE AS
...
CREATE INDEX wdoecm_geom_:vDATE:vidx ON :vSCHEMA.wdoecm_geom_:vDATE USING gist(geom);
