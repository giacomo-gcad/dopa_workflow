...
FROM :wdpaschema.wdpa_o5_buffers_:vDATE
ORDER BY wdpaid;

CREATE TABLE :buschema.list_bu_tc AS
SELECT 'bu_'||a.wdpaid::text gname
FROM :wdpaschema.wdpa_o5_buffers_:vDATE a
LEFT JOIN :wdpaschema.wdpa_o5_:vDATE b ON a.wdpaid=b.wdpaid
WHERE b.marine NOT IN (2)
ORDER BY a.wdpaid;
