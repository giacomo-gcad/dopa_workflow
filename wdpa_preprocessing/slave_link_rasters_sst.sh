...
r.in.gdal -o --quiet --overwrite input=NETCDF:${ORIGDATA}"/MARINE_SST/archives/METOFFICE-GLO-SST-L4-NRT-OBS-SST-MON-V2_1557235783317.nc":analysed_sst output=sst num_digits=3
...
t.register --quiet --overwrite -i type=raster input=sst_mean@SST maps=`g.list raster pattern="sst*" sep=comma` start=2007-01-15 increment="1 months"
