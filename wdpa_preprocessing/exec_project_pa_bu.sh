...
grass ${PA_MO_MAPSET_PATH} --exec v.info pa_555603331@${PA_MAPSET}|grep "Name:"
grass ${PA_MO_MAPSET_PATH} --exec v.info pa_555626104@${PA_MAPSET}|grep "Name:"

# MANUAL CHECK OF LOG FILE: IF v.info ABOVE DO NOT GIVE ERRORS (MEANING THAT THOSE PAs STILL EXIST) RUN THE 
# COMMANDS HERE BELOW:
...
echo "-----------------------------------------------------------------------------------"
echo "PAs and BUs reprojected in "${runtime}" minutes"
echo "-----------------------------------------------------------------------------------"
